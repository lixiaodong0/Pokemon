...
fun HomeScreen(videoModel: HomeViewModel = viewModel()) {
    val viewStatus = videoModel.viewStatus.collectAsState()
    Column {
        Button(onClick = {
        ...
        Log.d("lixd", "frontDefault:${frontDefault}")
        Log.d("lixd", "frontShiny:${frontShiny}")
        Log.d("lixd", "backDefault:${backDefault}")
        Log.d("lixd", "backShiny:${backShiny}")
    }
}